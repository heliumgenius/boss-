...
class TestClient:
    ...
    def test_client_context_manager(self):
        from boss_cli.auth import Credential
        from boss_cli.client.transport import BossClient
    ...
    def test_burst_penalty_kicks_in_after_multiple_requests(self, monkeypatch):
        ...
        with BossClient(cred) as client:
            ...
            monkeypatch.setattr("boss_cli.client.throttle.time.time", lambda: now)
...
class TestUserAgentRotation:
    """Test User-Agent rotation in client headers."""

    def test_user_agent_is_set(self):
        from boss_cli.client.transport import BossClient
        with BossClient(credential=None) as client:
            headers = client._headers_for_request("/test")
...
class TestAuthHealthVerification:
    ...
    def test_verify_credential_details_uses_ttl_cache(self, monkeypatch):
        ...
        monkeypatch.setattr("boss_cli.client.transport.BossClient", FakeClient)
